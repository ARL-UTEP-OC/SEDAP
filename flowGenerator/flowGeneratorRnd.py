...
numOutFlowsPerNode = int(sys.argv[2])
...
for node in range(1, numNodes + 1):
    ...
    if node not in outFlowHash:
        outFlowHash[node] = []
    for i in range(0,numOutFlowsPerNode):
        outFlowPattern.append(random.randint(1,numNodes-1))
